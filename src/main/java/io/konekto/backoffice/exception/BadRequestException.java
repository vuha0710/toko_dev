package io.konekto.backoffice.exception;

import io.konekto.backoffice.domain.constant.ErrorConstant;
...
public class BadRequestException extends AbstractThrowableProblem {
    ...
    public BadRequestException(String defaultMessage) {
        this(ErrorConstant.DEFAULT_TYPE, defaultMessage, null, null);
    }
